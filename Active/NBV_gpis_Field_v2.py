...
if __name__ == "__main__":
    ...
    ap.add_argument(
        "--in_path",
        type=str,
        default="/home/ferry/data/Code2/Research/Inhand_Activate/reconstruction/offline/result/offline_tracking/cube_obj_02/002_ICP/pcd_online/recon_0_000100.ply"
    )
