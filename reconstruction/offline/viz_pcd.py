...
def main():
    ...
    parser.add_argument("-i", "--input", default="/home/ferry/data/Code2/Research/Inhand_Activate/reconstruction/offline/result/yellow_cylinder_002/pcd/recon_0_000110.ply", help="Path to point cloud (ply/pcd/xyz/xyzn/xyzrgb) or mesh (obj/stl/off).")
